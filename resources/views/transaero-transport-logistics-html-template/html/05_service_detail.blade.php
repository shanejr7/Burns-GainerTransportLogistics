			...
			<div class="row">
				...
				<div class="page-header-breadcrumb">
					<ol class="breadcrumb">
						...
						<li><a href="04_services.html">Services</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<ul class="service-menu">
						<li class="active">
							<a href="04_services.html">ALL SERVICES</a>
						</li>
						<li>
							<a href="05_service_detail.html">road Freight</a>
						</li>
						<li>
							<a href="05_service_detail.html">AIR FREIGHT</a>
						</li>
						<li>
							<a href="05_service_detail.html">OCEAN Freight</a>
						</li>
						<li>
							<a href="05_service_detail.html">EXPEDITED</a>
						</li>
						<li>
							<a href="05_service_detail.html">warehousing</a>
						</li>
						<li>
							<a href="05_service_detail.html">packaging & storage</a>
						</li>
					</ul>
				</div>
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					...
					<div class="service-detail">
						...
						<div class="service-detail-bigimage">
							<img src="assets/media/service/7.jpg" alt="" />
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="service-related">
									<div class="service-related-image">
										<img src="assets/media/service/8.jpg" alt="" />
									</div>
									<div class="service-related-title">
										<h3><a href="05_service_detail.html">packaging & storage</a></h3>
									</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="service-related">
									<div class="service-related-image">
										<img src="assets/media/service/9.jpg" alt="" />
									</div>
									<div class="service-related-title">
										<h3><a href="05_service_detail.html">warehousing & EXPEDITED</a></h3>
									</div>
									<div class="service-related-text">
										<p>
											Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. 
