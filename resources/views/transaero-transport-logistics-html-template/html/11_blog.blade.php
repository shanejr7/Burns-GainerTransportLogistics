				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 blog-items">
						...
						<div class="blog-item blog-item-mark">
							<div class="blog-item-date">
								<div class="blog-item-date-number">26</div>MAY
							</div>
							...
							<div class="blog-item-button">
								<a href="12_blog_detail.html"><div class="my-btn my-btn-primary">
									<div class="my-btn-bg-top"></div>
									<div class="my-btn-bg-bottom"></div>
									<div class="my-btn-text">
										READ MORE
						...
						<div class="blog-item">
							<div class="blog-item-date">
								<div class="blog-item-date-number">2</div>MAY
							</div>
							<div class="blog-item-image">
							...
							<div class="blog-item-info">
								...
								<a href="#">Admin</a>
								<span class="date-icon"><i class="fa fa-calendar"></i></span>
								<a href="12_blog_detail.html">2 may 2015</a>
							</div>
							<div class="blog-item-title">
								<h3><a href="12_blog_detail.html">Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. </a></h3>
							</div>
							<div class="blog-item-text">
								<p>
									Fusce ante augue, convallis sit amet, volutpat ac posuere vel quam. Lorem ipsuml dolor sit amet consecetuds adipiscing elit. Vestibulum acdris 
							...
							<div class="blog-item-button">
								<a href="12_blog_detail.html"><div class="my-btn my-btn-grey">
									<div class="my-btn-bg-top"></div>
									<div class="my-btn-bg-bottom"></div>
									<div class="my-btn-text">
										READ MORE
