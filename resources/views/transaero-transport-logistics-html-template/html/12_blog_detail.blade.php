				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						...
						<div class="single-post">
							...
							<div class="single-post-title">
								<h3><a href="12_blog_detail.html">Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc.</a></h3>
							</div>
							<div class="single-post-text">
								...
								<p>
									...
									volutpat a, suscipit non, turpis. Nullam sagittis. Suspendisse pulvinar, augue ac venenatis condimentum, sem libero volutpat nibh, nec 
									pellentesque velit pede quis nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Fusce id purus. 
								...
								<p>
									In dui magna, posuere eget, vestibulum et, tempor auctor, justo. In ac felis quis tortor malesuada pretium. Pellentesque auctor neque nec 
									urna. Proin sapien ipsum, porta a, auctor quis, euismod ut, mi. Aenean viverra rhoncus pede. Pellentesque habitant morbi tristique senectus et 
									netus et malesuada fames ac turpis egestas. Ut non enim eleifend felis pretium feugiat. Vivamus quis mi. Phasellus a est. Phasellus magna.
								</p>
								<div class="my-blockquote">
									<div class="my-blockquote-quote"><div><i class="fa fa-quote-left"></i></div></div>
									<p>
										Fusce ante augue convallis sit amet volutpat posuere vel quam. Lorem ipsuml dolor sit amet
										cons dece stuer adipiscing elit. Vestibulum acd risus nec eros auctor egestas. Maecenas dolor
										Sed nunc nonl moles tied hendrerit. Quisque consectetuer dui sed libero. Integer norci vitae
										lacu ultricies mattis. Lorem ipsum dolor sit amet.
									</p>
								</div>
								<p>
									In hac habitasse platea dictumst. Curabitur at lacus ac velit ornare lobortis. Curabitur a felis in nunc fringilla tristique. Morbi mattis 
									...
									Sed hendrerit. Morbi ac felis. Nunc egestas, augue at pellentesque laoreet, felis eros vehicula leo, at malesuada velit leo quis pede. Donec 
									interdum, metus et hendrerit aliquet, dolor diam sagittis ligula, eget egestas libero turpis vel mi. Nunc nulla. Fusce risus nisl, viverra et, tempor 
									et, pretium in, sapien. Donec venenatis vulputate lorem.
								</p>
							</div>
							...
							<div class="single-post-author">
								<div class="single-post-author-avatar">
									<img src="assets/media/team/7.jpg" alt="" />
								</div>
								<div class="single-post-author-info">
									...
									<div class="single-post-author-info-text">
										Hestibulum ac risus nec eros auctor egestas maecna eid dolor sed nunc leo. Lorem ipsu dolor sitconsectetur 
										adipisicing elit sed do eiusmod tempor incididunt ut labore  dolore aliqua enim admminim veniam quis 
									...
									<div class="media-body">
										<div class="media-body-top">
											<div class="media-info">
												<h4 class="media-heading">BOB SAAP</h4>
										...
										Fusce ante augue, convallis sit amet volutpat posuere vel quam. Lorem ipsuml dolor sit nsece tcsladipiscing elit. 
										Vestibulum acd risus nec eros auctor egestas. Maece dolor sed ipsuunc molestiaLorem ipsum dolor sit amet 
										consecte tur adipisicing elit.
									</div>
								</div>
								
								<div class="media">
									<a class="pull-left" href="#">
										<img class="media-object" src="assets/media/team/4.jpg" alt="" />
									</a>
									<div class="media-body">
										<div class="media-body-top">
											<div class="media-info">
												<h4 class="media-heading">ALBERT MILLER</h4>
												<span class="media-date">25 AUG 2015 at 5:00 PM</span>
											</div>
											<div class="media-reply">
												<a href="#"><div class="my-btn my-btn-default">
