	<footer class="def-section footer">
		<div class="container">
			<div class="row">
				...
				<!-- === FOOTER COLUMN === -->
				<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 footer-1">
					...
					<div class="footer-1-text">
						<p >Trucking transport for food and clothing. We have a refrigerated trailer shipping refrigerated or dry goods
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-3">
					<h4 class="with-square with-border-bottom">CUSTOMER CONTACT</h4>
					...
					<div class="footer-3-mail footer-3-item">
						...
						E-mail: Barbgainer3@gmail.com
					</div>
						<div class="footer-3-mail footer-3-item">
						<span class="footer-3-icon"><i class="fa fa-envelope"></i></span>
						E-mail: Darian.gainer@gmail.com
					</div>
