		...
		<section class="def-section about-quote">
			...
			<div class="container">
				<div class="row">
					...
					<!-- 	<p>
						...
						<div class="home-about-video">
							...
							<video id="aboutvideo" loop="loop" preload="auto">
								<source src="assets/media/video/trucks.mp4" />
								<source src="assets/media/video/trucks.webm" type="video/webm" />
							</video>
					...
					<!-- === GET QUOTE === -->	
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 get-quote" id="formArea">
					...
					<!-- 	<p>
						...
						<div class="get-quote-form">
							...
							<form name="gq-form" id="gq-form" method="POST" action="/quote/request">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 get-quote-form-left">
									<!-- === GET QUOTE FORM ITEM === -->
									<div class="form-item">
										<input type="text" name="name" id="gq-location" placeholder="FULL NAME" />
										@error('name')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
									<div class="form-item">
										<input type="text" name="location" id="gq-location" placeholder="LOCATION" />
										@error('location')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
									<!-- === GET QUOTE FORM ITEM === -->
									<div class="form-item">
										<input type="text" name="phone" id="gq-person" placeholder="PHONE" />
										@error('phone')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 get-quote-form-right">
									<!-- === GET QUOTE FORM ITEM === -->
									<div class="form-item">
										<input type="text" name="email" id="gq-contact" placeholder="E-MAIL" />
										@error('email')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
									<!-- === GET QUOTE FORM ITEM === -->
									<div class="form-item">
										<input type="text" name="destination" id="gq-destination" placeholder="TO DESTINATION" />
										@error('destination')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 get-quote-form-bottom">
									<!-- === GET QUOTE FORM ITEM === -->
									<div class="form-item">
										<textarea name="message" id="gq-text" placeholder="MESSAGE"></textarea>
										@error('message')
										<p class="alert" style="color: red;">{{$message}}</p>
										@enderror
									</div>
									...
									<div class="get-quote-form-button">
										<button id="gq-submit" type="submit"><span class="my-btn my-btn-grey">
...
<!-- 	<section class="def-section">
	...
	<!-- ===================================
		SECTION STATS
		======================================== -->
		<div class="def-section stats" id="home-stats" data-stellar-background-ratio="0.4" style="background-image: url('assets/media/main-slider/nav_img.jpg');">
